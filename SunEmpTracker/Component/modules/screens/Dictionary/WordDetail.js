...
export default class wordCard extends Component { 
    ...
    constructor(){
        ...
        this.state = {
            ...
            upCount:0,
            downCount:0,
            upVoteColor:Colors.grayLight,
            downVoteColor:Colors.grayLight
        }
    }
    ...
    componentDidMount(){
        ...
        console.log("Data All  "+JSON.stringify(this.props.data, null, 2) );
    ...
    onShareItem(item) {
        Share.share({
            message:"",
            url: "",
            title:'SunEmpTracker Dictionary'
        })
    ...
    onVotePress(defid, vote){
        ...
        .then((voteResponse) => {
            this.setState({
                ...
                upVoteColor:(vote === 'up')? Colors.headerBack : Colors.grayLight,
                downVoteColor:(vote === 'down')? Colors.headerBack : Colors.grayLight
            })
    ...
    render() {
        return (
            <View style ={{flex: 1,marginLeft:8,marginRight:8,marginTop:4}}>

                <Card style={{flex: 1}}>
                    <CardItem>
                        <View style ={{flex: 1}}>
                            {/*<Text style ={styles.topDesription}> {this.props.data.written_on} </Text>*/}
                            ...
                            <View style={styles.footer}>
                                <View style={styles.buttonGroup}>
                                    <TouchableHighlight underlayColor='rgba(216, 216, 216, 0.5)' style={{padding:10, height:40}} onPress={() => this.onVotePress({/*this.props.data.defid*/}, 'down')}>
                                    ...
                                    <TouchableHighlight underlayColor='rgba(216, 216, 216, 0.5)' style={{padding:10, height:40, marginHorizontal:1}} onPress={() => this.onVotePress(this.props.data.defid, 'up')}>
                                        <View style={{flexDirection:'row', alignItems:'center', justifyContent:'center'}}>
                                ...
                                <View style={styles.actionButton}>
                                    <TouchableHighlight underlayColor='rgba(216, 216, 216, 0.5)' style={{padding:10, height:40, marginHorizontal:1}} onPress={() => this.onShareItem()}>
                                        <View style={{flexDirection:'row', alignItems:'center', justifyContent:'center'}}>
                                            <Icon name="send" color={Colors.headerBack} size={30}/>
                                        </View>
                                    </TouchableHighlight>
