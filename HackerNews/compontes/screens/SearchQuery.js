...
export default class SearchQuery extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            SelectFoormDateFormated: Moment().format('DD MMM YYYY'),
                            ...
                            <View style={{width: '100%'}}>
                               ...
                               {/* <Item style={{borderBottomWidth: 0, width: '100%'}}>
                                ...
                                <Text numberOfLines={1} style={{
                                    ...
                                    color: Colors.mainHeading,
                                    fontSize: 16
                                }}>Select Publishers : {this.state.categoryList[this.state.SelectCatPostion].name} !</Text>
                                ...
                                <Text numberOfLines={1} style={{
                                    ...
                                    color: Colors.mainHeading,
                                    fontSize: 16
                                }}>Select Publishers : {this.state.languageList[this.state.SelectLangPostion].name} !</Text>*/}
